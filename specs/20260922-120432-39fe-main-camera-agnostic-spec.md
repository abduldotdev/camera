...
1. **Hardcoded Device Path & Fixed Model Metadata**:
   - In [`Model.js`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/Model.js#L12), line 12 hardcodes `var DEFAULT_DEVICE = "/dev/video0"`.
   - In [`Widget.qml`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/Widget.qml#L22), line 22 binds `property string device: (typeof Model !== "undefined" && Model.DEFAULT_DEVICE) ? Model.DEFAULT_DEVICE : "/dev/video0"`, line 38 hardcodes `property string modelName: "Logitech MX Brio"`, and `checkDeviceProc` (lines 267–295) tests only that single file path via `test -e "$1"`.
   - In [`CameraPopup.qml`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/CameraPopup.qml#L27-L28), lines 27–28 hardcode `modelName: "Logitech MX Brio"` and `devicePath: "/dev/video0"`. The header (lines 531–539) unconditionally renders this static string. If the user's camera is registered at `/dev/video2` or `/dev/video4`, the plugin reports the device as disconnected.
...
2. **Rigid Hardcoded Control Catalog & Inflexible Reset Commands**:
   - In [`Model.js`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/Model.js#L33-L199), `var CONTROLS = { ... }` hardcodes fixed ranges, step values, and defaults for 18 controls tailored exclusively to the MX Brio (e.g. `white_balance_temperature` min 2800 max 7500 default 5000; `exposure_time_absolute` min 3 max 2047 default 156; `pan_absolute`/`tilt_absolute` min -72000 max 72000 step 3600; `zoom_absolute` min 100 max 400).
   - In [`Model.js`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/Model.js#L746-L790), `buildResetCommands(device)` unconditionally emits `v4l2-ctl --set-ctrl` commands for ALL catalog controls regardless of device support:
...
3. **Static UI Controls with "Phantom" Widgets & Hardcoded Slider Bounds**:
   - In [`CameraPopup.qml`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/CameraPopup.qml#L690-L984), `sectionsCol` renders every single control unconditionally. Only `logitech_brio_fov` is gated on `root.fovAvailable` (line 702), and only Pan & Tilt use `getMeta()` for limits (lines 727–729, 736–738).
...
5. **Outdated Manifest & Documentation**:
   - [`manifest.json`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/manifest.json#L8) and [`README.md`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/README.md#L3) state that the plugin is made specifically for the Logitech MX Brio 4K (`046d:0944`), warning that only the MX Brio is tested and supported.

6. **Test Suite Blind Spots**:
   - [`tests/model.test.js`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/tests/model.test.js#L8-L36) only contains fixtures for the Logitech MX Brio. It lacks test coverage for generic UVC webcams with different control sets, limits, and menu values, as well as device discovery parsing.
   - [`tests/hardware.test.js`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/tests/hardware.test.js#L6) hardcodes `/dev/video0` and unconditionally iterates the MX Brio catalog, failing on machines where a non-Brio camera is connected or when the camera is on a different node.
...
2. **Multi-Camera Selection in Popup UI**:
   - When more than one video capture device is discovered, present a clean device selector in [`CameraPopup.qml`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/CameraPopup.qml) allowing the user to select the active camera.
...
3. **Dynamic Control Rendering & Dynamic Slider Limits**:
   - In [`CameraPopup.qml`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/CameraPopup.qml), render ONLY controls that the selected device actually exposes in `root.controls` (no phantom controls, no failed CLI commands).
...
4. **Dynamic Factory Reset**:
   - In [`Model.js`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/Model.js), extend `buildResetCommands(device, controls)` so that it only emits reset commands for controls that are actually present on the active device.
...
6. **Documentation & Manifest Modernization**:
   - Update [`manifest.json`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/manifest.json) to describe the plugin as a camera-agnostic V4L2/UVC webcam controller, citing the Logitech MX Brio as the reference hardware.
   - Update [`README.md`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/README.md) to detail universal V4L2/UVC webcam support, dynamic control enumeration, multi-camera switching, and extended IPC commands.
7. **Comprehensive Test Suite Extension**:
   - Extend [`tests/model.test.js`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/tests/model.test.js) with:
   ...
   - Update [`tests/hardware.test.js`](file:///home/abdul891/Documents/projects/omarchy-plugins/.orch-worktrees/abduldotdev.camera-20260922-120432-39fe-main-sup-1/tests/hardware.test.js) to:
